...
⬡ Upload: ${ago}
⬡ Link: ${url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'http://wa.me/6289653898291' },
...
body: wm,
sourceUrl: 'http://wa.me/6289653898291', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
...
handler.help = ['ply'].map(v => v + ' <pencarian>')
